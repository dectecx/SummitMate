...
@override@JsonKey() List<String> get dayNames {
 ...
 final  List<MealPlanDay> _mealPlanDays;
@override@JsonKey() List<MealPlanDay> get mealPlanDays {
  if (_mealPlanDays is EqualUnmodifiableListView) return _mealPlanDays;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_mealPlanDays);
}
