...
mixin _$GroupEvent {
 ...
 String get id; String get creatorId; String get title; String get description; GroupEventCategory get category; String get location; DateTime get startDate; DateTime? get endDate; GroupEventStatus get status; int get maxMembers; int get applicationCount; int get totalApplicationCount; bool get approvalRequired; String get privateMessage; String? get linkedTripId; TripSnapshot? get tripSnapshot; DateTime? get snapshotUpdatedAt; int get likeCount; int get commentCount; bool get isLiked; GroupEventApplicationStatus? get myApplicationStatus; String get creatorName; String get creatorAvatar; List<GroupEventComment> get latestComments; SyncStatus get syncStatus; DateTime get createdAt; String get createdBy; DateTime get updatedAt; String get updatedBy;
...
@useResult
$Res call({
 String id, String creatorId, String title, String description, GroupEventCategory category, String location, DateTime startDate, DateTime? endDate, GroupEventStatus status, int maxMembers, int applicationCount, int totalApplicationCount, bool approvalRequired, String privateMessage, String? linkedTripId, TripSnapshot? tripSnapshot, DateTime? snapshotUpdatedAt, int likeCount, int commentCount, bool isLiked, GroupEventApplicationStatus? myApplicationStatus, String creatorName, String creatorAvatar, List<GroupEventComment> latestComments, SyncStatus syncStatus, DateTime createdAt, String createdBy, DateTime updatedAt, String updatedBy
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String creatorId,  String title,  String description,  GroupEventCategory category,  String location,  DateTime startDate,  DateTime? endDate,  GroupEventStatus status,  int maxMembers,  int applicationCount,  int totalApplicationCount,  bool approvalRequired,  String privateMessage,  String? linkedTripId,  TripSnapshot? tripSnapshot,  DateTime? snapshotUpdatedAt,  int likeCount,  int commentCount,  bool isLiked,  GroupEventApplicationStatus? myApplicationStatus,  String creatorName,  String creatorAvatar,  List<GroupEventComment> latestComments,  SyncStatus syncStatus,  DateTime createdAt,  String createdBy,  DateTime updatedAt,  String updatedBy)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GroupEvent() when $default != null:
return $default(_that.id,_that.creatorId,_that.title,_that.description,_that.category,_that.location,_that.startDate,_that.endDate,_that.status,_that.maxMembers,_that.applicationCount,_that.totalApplicationCount,_that.approvalRequired,_that.privateMessage,_that.linkedTripId,_that.tripSnapshot,_that.snapshotUpdatedAt,_that.likeCount,_that.commentCount,_that.isLiked,_that.myApplicationStatus,_that.creatorName,_that.creatorAvatar,_that.latestComments,_that.syncStatus,_that.createdAt,_that.createdBy,_that.updatedAt,_that.updatedBy);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String creatorId,  String title,  String description,  GroupEventCategory category,  String location,  DateTime startDate,  DateTime? endDate,  GroupEventStatus status,  int maxMembers,  int applicationCount,  int totalApplicationCount,  bool approvalRequired,  String privateMessage,  String? linkedTripId,  TripSnapshot? tripSnapshot,  DateTime? snapshotUpdatedAt,  int likeCount,  int commentCount,  bool isLiked,  GroupEventApplicationStatus? myApplicationStatus,  String creatorName,  String creatorAvatar,  List<GroupEventComment> latestComments,  SyncStatus syncStatus,  DateTime createdAt,  String createdBy,  DateTime updatedAt,  String updatedBy)  $default,) {final _that = this;
switch (_that) {
case _GroupEvent():
return $default(_that.id,_that.creatorId,_that.title,_that.description,_that.category,_that.location,_that.startDate,_that.endDate,_that.status,_that.maxMembers,_that.applicationCount,_that.totalApplicationCount,_that.approvalRequired,_that.privateMessage,_that.linkedTripId,_that.tripSnapshot,_that.snapshotUpdatedAt,_that.likeCount,_that.commentCount,_that.isLiked,_that.myApplicationStatus,_that.creatorName,_that.creatorAvatar,_that.latestComments,_that.syncStatus,_that.createdAt,_that.createdBy,_that.updatedAt,_that.updatedBy);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String creatorId,  String title,  String description,  GroupEventCategory category,  String location,  DateTime startDate,  DateTime? endDate,  GroupEventStatus status,  int maxMembers,  int applicationCount,  int totalApplicationCount,  bool approvalRequired,  String privateMessage,  String? linkedTripId,  TripSnapshot? tripSnapshot,  DateTime? snapshotUpdatedAt,  int likeCount,  int commentCount,  bool isLiked,  GroupEventApplicationStatus? myApplicationStatus,  String creatorName,  String creatorAvatar,  List<GroupEventComment> latestComments,  SyncStatus syncStatus,  DateTime createdAt,  String createdBy,  DateTime updatedAt,  String updatedBy)?  $default,) {final _that = this;
switch (_that) {
case _GroupEvent() when $default != null:
return $default(_that.id,_that.creatorId,_that.title,_that.description,_that.category,_that.location,_that.startDate,_that.endDate,_that.status,_that.maxMembers,_that.applicationCount,_that.totalApplicationCount,_that.approvalRequired,_that.privateMessage,_that.linkedTripId,_that.tripSnapshot,_that.snapshotUpdatedAt,_that.likeCount,_that.commentCount,_that.isLiked,_that.myApplicationStatus,_that.creatorName,_that.creatorAvatar,_that.latestComments,_that.syncStatus,_that.createdAt,_that.createdBy,_that.updatedAt,_that.updatedBy);case _:
  return null;
...
@override
int get hashCode => Object.hashAll([runtimeType,id,creatorId,title,description,category,location,startDate,endDate,status,maxMembers,applicationCount,totalApplicationCount,approvalRequired,privateMessage,linkedTripId,tripSnapshot,snapshotUpdatedAt,likeCount,commentCount,isLiked,myApplicationStatus,creatorName,creatorAvatar,const DeepCollectionEquality().hash(_latestComments),syncStatus,createdAt,createdBy,updatedAt,updatedBy]);
