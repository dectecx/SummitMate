...
mixin _$GroupEventResponse {
 ...
 String get id;@JsonKey(name: 'host_id') String get hostId;@JsonKey(name: 'host_name', defaultValue: '') String get hostName;@JsonKey(name: 'host_avatar', defaultValue: '🐻') String get hostAvatar; String get title;@JsonKey(defaultValue: '') String get description;@JsonKey(defaultValue: GroupEventCategory.other) GroupEventCategory get category;@JsonKey(defaultValue: '') String get location;// start_date / end_date are date-only fields (format: date in OpenAPI)
@JsonKey(name: 'start_date')@DateOnlyConverter() DateTime get startDate;@JsonKey(name: 'end_date')@NullableDateOnlyConverter() DateTime? get endDate;@JsonKey(defaultValue: 'open') String get status;@JsonKey(name: 'max_members', defaultValue: 0) int get maxMembers;@JsonKey(name: 'application_count', defaultValue: 0) int get applicationCount;@JsonKey(name: 'total_application_count', defaultValue: 0) int get totalApplicationCount;@JsonKey(name: 'approval_required', defaultValue: false) bool get approvalRequired;@JsonKey(name: 'private_message', defaultValue: '') String get privateMessage;@JsonKey(name: 'linked_trip_id') String? get linkedTripId;@JsonKey(name: 'trip_snapshot') TripSnapshotResponse? get tripSnapshot;@JsonKey(name: 'snapshot_updated_at')@NullableDateTimeUtcConverter() DateTime? get snapshotUpdatedAt;@JsonKey(name: 'like_count', defaultValue: 0) int get likeCount;@JsonKey(name: 'comment_count', defaultValue: 0) int get commentCount;@JsonKey(name: 'is_liked', defaultValue: false) bool get isLiked;@JsonKey(name: 'my_application_id') String? get myApplicationId;@JsonKey(name: 'my_application_status') String? get myApplicationStatus;@JsonKey(name: 'my_application_reason') String? get myApplicationReason;@JsonKey(name: 'latest_comments', defaultValue: []) List<GroupEventCommentResponse> get latestComments;@JsonKey(name: 'created_at')@DateTimeUtcConverter() DateTime get createdAt;@JsonKey(name: 'created_by') String get createdBy;@JsonKey(name: 'updated_at')@DateTimeUtcConverter() DateTime get updatedAt;@JsonKey(name: 'updated_by') String get updatedBy;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,hostId,hostName,hostAvatar,title,description,category,location,startDate,endDate,status,maxMembers,applicationCount,totalApplicationCount,approvalRequired,privateMessage,linkedTripId,tripSnapshot,snapshotUpdatedAt,likeCount,commentCount,isLiked,myApplicationId,myApplicationStatus,myApplicationReason,const DeepCollectionEquality().hash(latestComments),createdAt,createdBy,updatedAt,updatedBy]);

@override
String toString() {
  return 'GroupEventResponse(id: $id, hostId: $hostId, hostName: $hostName, hostAvatar: $hostAvatar, title: $title, description: $description, category: $category, location: $location, startDate: $startDate, endDate: $endDate, status: $status, maxMembers: $maxMembers, applicationCount: $applicationCount, totalApplicationCount: $totalApplicationCount, approvalRequired: $approvalRequired, privateMessage: $privateMessage, linkedTripId: $linkedTripId, tripSnapshot: $tripSnapshot, snapshotUpdatedAt: $snapshotUpdatedAt, likeCount: $likeCount, commentCount: $commentCount, isLiked: $isLiked, myApplicationId: $myApplicationId, myApplicationStatus: $myApplicationStatus, myApplicationReason: $myApplicationReason, latestComments: $latestComments, createdAt: $createdAt, createdBy: $createdBy, updatedAt: $updatedAt, updatedBy: $updatedBy)';
}
...
@useResult
$Res call({
 String id,@JsonKey(name: 'host_id') String hostId,@JsonKey(name: 'host_name', defaultValue: '') String hostName,@JsonKey(name: 'host_avatar', defaultValue: '🐻') String hostAvatar, String title,@JsonKey(defaultValue: '') String description,@JsonKey(defaultValue: GroupEventCategory.other) GroupEventCategory category,@JsonKey(defaultValue: '') String location,@JsonKey(name: 'start_date')@DateOnlyConverter() DateTime startDate,@JsonKey(name: 'end_date')@NullableDateOnlyConverter() DateTime? endDate,@JsonKey(defaultValue: 'open') String status,@JsonKey(name: 'max_members', defaultValue: 0) int maxMembers,@JsonKey(name: 'application_count', defaultValue: 0) int applicationCount,@JsonKey(name: 'total_application_count', defaultValue: 0) int totalApplicationCount,@JsonKey(name: 'approval_required', defaultValue: false) bool approvalRequired,@JsonKey(name: 'private_message', defaultValue: '') String privateMessage,@JsonKey(name: 'linked_trip_id') String? linkedTripId,@JsonKey(name: 'trip_snapshot') TripSnapshotResponse? tripSnapshot,@JsonKey(name: 'snapshot_updated_at')@NullableDateTimeUtcConverter() DateTime? snapshotUpdatedAt,@JsonKey(name: 'like_count', defaultValue: 0) int likeCount,@JsonKey(name: 'comment_count', defaultValue: 0) int commentCount,@JsonKey(name: 'is_liked', defaultValue: false) bool isLiked,@JsonKey(name: 'my_application_id') String? myApplicationId,@JsonKey(name: 'my_application_status') String? myApplicationStatus,@JsonKey(name: 'my_application_reason') String? myApplicationReason,@JsonKey(name: 'latest_comments', defaultValue: []) List<GroupEventCommentResponse> latestComments,@JsonKey(name: 'created_at')@DateTimeUtcConverter() DateTime createdAt,@JsonKey(name: 'created_by') String createdBy,@JsonKey(name: 'updated_at')@DateTimeUtcConverter() DateTime updatedAt,@JsonKey(name: 'updated_by') String updatedBy
});


$TripSnapshotResponseCopyWith<$Res>? get tripSnapshot;
...
as TripSnapshotResponse?,snapshotUpdatedAt: freezed == snapshotUpdatedAt ? _self.snapshotUpdatedAt : snapshotUpdatedAt // ignore: cast_nullable_to_non_nullable
...
as String?,myApplicationReason: freezed == myApplicationReason ? _self.myApplicationReason : myApplicationReason // ignore: cast_nullable_to_non_nullable
...
$TripSnapshotResponseCopyWith<$Res>? get tripSnapshot {
  ...
  return $TripSnapshotResponseCopyWith<$Res>(_self.tripSnapshot!, (value) {
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'host_id')  String hostId, @JsonKey(name: 'host_name', defaultValue: '')  String hostName, @JsonKey(name: 'host_avatar', defaultValue: '🐻')  String hostAvatar,  String title, @JsonKey(defaultValue: '')  String description, @JsonKey(defaultValue: GroupEventCategory.other)  GroupEventCategory category, @JsonKey(defaultValue: '')  String location, @JsonKey(name: 'start_date')@DateOnlyConverter()  DateTime startDate, @JsonKey(name: 'end_date')@NullableDateOnlyConverter()  DateTime? endDate, @JsonKey(defaultValue: 'open')  String status, @JsonKey(name: 'max_members', defaultValue: 0)  int maxMembers, @JsonKey(name: 'application_count', defaultValue: 0)  int applicationCount, @JsonKey(name: 'total_application_count', defaultValue: 0)  int totalApplicationCount, @JsonKey(name: 'approval_required', defaultValue: false)  bool approvalRequired, @JsonKey(name: 'private_message', defaultValue: '')  String privateMessage, @JsonKey(name: 'linked_trip_id')  String? linkedTripId, @JsonKey(name: 'trip_snapshot')  TripSnapshotResponse? tripSnapshot, @JsonKey(name: 'snapshot_updated_at')@NullableDateTimeUtcConverter()  DateTime? snapshotUpdatedAt, @JsonKey(name: 'like_count', defaultValue: 0)  int likeCount, @JsonKey(name: 'comment_count', defaultValue: 0)  int commentCount, @JsonKey(name: 'is_liked', defaultValue: false)  bool isLiked, @JsonKey(name: 'my_application_id')  String? myApplicationId, @JsonKey(name: 'my_application_status')  String? myApplicationStatus, @JsonKey(name: 'my_application_reason')  String? myApplicationReason, @JsonKey(name: 'latest_comments', defaultValue: [])  List<GroupEventCommentResponse> latestComments, @JsonKey(name: 'created_at')@DateTimeUtcConverter()  DateTime createdAt, @JsonKey(name: 'created_by')  String createdBy, @JsonKey(name: 'updated_at')@DateTimeUtcConverter()  DateTime updatedAt, @JsonKey(name: 'updated_by')  String updatedBy)  $default,) {final _that = this;
switch (_that) {
case _GroupEventResponse():
return $default(_that.id,_that.hostId,_that.hostName,_that.hostAvatar,_that.title,_that.description,_that.category,_that.location,_that.startDate,_that.endDate,_that.status,_that.maxMembers,_that.applicationCount,_that.totalApplicationCount,_that.approvalRequired,_that.privateMessage,_that.linkedTripId,_that.tripSnapshot,_that.snapshotUpdatedAt,_that.likeCount,_that.commentCount,_that.isLiked,_that.myApplicationId,_that.myApplicationStatus,_that.myApplicationReason,_that.latestComments,_that.createdAt,_that.createdBy,_that.updatedAt,_that.updatedBy);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id, @JsonKey(name: 'host_id')  String hostId, @JsonKey(name: 'host_name', defaultValue: '')  String hostName, @JsonKey(name: 'host_avatar', defaultValue: '🐻')  String hostAvatar,  String title, @JsonKey(defaultValue: '')  String description, @JsonKey(defaultValue: GroupEventCategory.other)  GroupEventCategory category, @JsonKey(defaultValue: '')  String location, @JsonKey(name: 'start_date')@DateOnlyConverter()  DateTime startDate, @JsonKey(name: 'end_date')@NullableDateOnlyConverter()  DateTime? endDate, @JsonKey(defaultValue: 'open')  String status, @JsonKey(name: 'max_members', defaultValue: 0)  int maxMembers, @JsonKey(name: 'application_count', defaultValue: 0)  int applicationCount, @JsonKey(name: 'total_application_count', defaultValue: 0)  int totalApplicationCount, @JsonKey(name: 'approval_required', defaultValue: false)  bool approvalRequired, @JsonKey(name: 'private_message', defaultValue: '')  String privateMessage, @JsonKey(name: 'linked_trip_id')  String? linkedTripId, @JsonKey(name: 'trip_snapshot')  TripSnapshotResponse? tripSnapshot, @JsonKey(name: 'snapshot_updated_at')@NullableDateTimeUtcConverter()  DateTime? snapshotUpdatedAt, @JsonKey(name: 'like_count', defaultValue: 0)  int likeCount, @JsonKey(name: 'comment_count', defaultValue: 0)  int commentCount, @JsonKey(name: 'is_liked', defaultValue: false)  bool isLiked, @JsonKey(name: 'my_application_id')  String? myApplicationId, @JsonKey(name: 'my_application_status')  String? myApplicationStatus, @JsonKey(name: 'my_application_reason')  String? myApplicationReason, @JsonKey(name: 'latest_comments', defaultValue: [])  List<GroupEventCommentResponse> latestComments, @JsonKey(name: 'created_at')@DateTimeUtcConverter()  DateTime createdAt, @JsonKey(name: 'created_by')  String createdBy, @JsonKey(name: 'updated_at')@DateTimeUtcConverter()  DateTime updatedAt, @JsonKey(name: 'updated_by')  String updatedBy)?  $default,) {final _that = this;
switch (_that) {
case _GroupEventResponse() when $default != null:
return $default(_that.id,_that.hostId,_that.hostName,_that.hostAvatar,_that.title,_that.description,_that.category,_that.location,_that.startDate,_that.endDate,_that.status,_that.maxMembers,_that.applicationCount,_that.totalApplicationCount,_that.approvalRequired,_that.privateMessage,_that.linkedTripId,_that.tripSnapshot,_that.snapshotUpdatedAt,_that.likeCount,_that.commentCount,_that.isLiked,_that.myApplicationId,_that.myApplicationStatus,_that.myApplicationReason,_that.latestComments,_that.createdAt,_that.createdBy,_that.updatedAt,_that.updatedBy);case _:
  return null;
...
class _GroupEventResponse implements GroupEventResponse {
  const _GroupEventResponse({required this.id, @JsonKey(name: 'host_id') required this.hostId, @JsonKey(name: 'host_name', defaultValue: '') required this.hostName, @JsonKey(name: 'host_avatar', defaultValue: '🐻') required this.hostAvatar, required this.title, @JsonKey(defaultValue: '') required this.description, @JsonKey(defaultValue: GroupEventCategory.other) required this.category, @JsonKey(defaultValue: '') required this.location, @JsonKey(name: 'start_date')@DateOnlyConverter() required this.startDate, @JsonKey(name: 'end_date')@NullableDateOnlyConverter() this.endDate, @JsonKey(defaultValue: 'open') required this.status, @JsonKey(name: 'max_members', defaultValue: 0) required this.maxMembers, @JsonKey(name: 'application_count', defaultValue: 0) required this.applicationCount, @JsonKey(name: 'total_application_count', defaultValue: 0) required this.totalApplicationCount, @JsonKey(name: 'approval_required', defaultValue: false) required this.approvalRequired, @JsonKey(name: 'private_message', defaultValue: '') required this.privateMessage, @JsonKey(name: 'linked_trip_id') this.linkedTripId, @JsonKey(name: 'trip_snapshot') this.tripSnapshot, @JsonKey(name: 'snapshot_updated_at')@NullableDateTimeUtcConverter() this.snapshotUpdatedAt, @JsonKey(name: 'like_count', defaultValue: 0) required this.likeCount, @JsonKey(name: 'comment_count', defaultValue: 0) required this.commentCount, @JsonKey(name: 'is_liked', defaultValue: false) required this.isLiked, @JsonKey(name: 'my_application_id') this.myApplicationId, @JsonKey(name: 'my_application_status') this.myApplicationStatus, @JsonKey(name: 'my_application_reason') this.myApplicationReason, @JsonKey(name: 'latest_comments', defaultValue: []) required final  List<GroupEventCommentResponse> latestComments, @JsonKey(name: 'created_at')@DateTimeUtcConverter() required this.createdAt, @JsonKey(name: 'created_by') required this.createdBy, @JsonKey(name: 'updated_at')@DateTimeUtcConverter() required this.updatedAt, @JsonKey(name: 'updated_by') required this.updatedBy}): _latestComments = latestComments;
...
@override@JsonKey(name: 'host_name', defaultValue: '') final  String hostName;
@override@JsonKey(name: 'host_avatar', defaultValue: '🐻') final  String hostAvatar;
...
@override@JsonKey(name: 'max_members', defaultValue: 0) final  int maxMembers;
...
@override@JsonKey(name: 'my_application_id') final  String? myApplicationId;
@override@JsonKey(name: 'my_application_status') final  String? myApplicationStatus;
@override@JsonKey(name: 'my_application_reason') final  String? myApplicationReason;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,hostId,hostName,hostAvatar,title,description,category,location,startDate,endDate,status,maxMembers,applicationCount,totalApplicationCount,approvalRequired,privateMessage,linkedTripId,tripSnapshot,snapshotUpdatedAt,likeCount,commentCount,isLiked,myApplicationId,myApplicationStatus,myApplicationReason,const DeepCollectionEquality().hash(_latestComments),createdAt,createdBy,updatedAt,updatedBy]);
...
@override $TripSnapshotResponseCopyWith<$Res>? get tripSnapshot;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,eventId,userId,status,message,rejectionReason,userName,userAvatar,createdAt,updatedAt,updatedBy);

@override
String toString() {
  return 'GroupEventApplicationResponse(id: $id, eventId: $eventId, userId: $userId, status: $status, message: $message, rejectionReason: $rejectionReason, userName: $userName, userAvatar: $userAvatar, createdAt: $createdAt, updatedAt: $updatedAt, updatedBy: $updatedBy)';
}
...
/// Create a copy of GroupEventApplicationResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? eventId = null,Object? userId = null,Object? status = null,Object? message = null,Object? rejectionReason = null,Object? userName = null,Object? userAvatar = null,Object? createdAt = null,Object? updatedAt = null,Object? updatedBy = null,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _GroupEventApplicationResponse() when $default != null:
return $default(_that.id,_that.eventId,_that.userId,_that.status,_that.message,_that.rejectionReason,_that.userName,_that.userAvatar,_that.createdAt,_that.updatedAt,_that.updatedBy);case _:
  return orElse();
...
@override@JsonKey(name: 'rejection_reason', defaultValue: '') final  String rejectionReason;
...
/// Create a copy of GroupEventApplicationResponse
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? eventId = null,Object? userId = null,Object? status = null,Object? message = null,Object? rejectionReason = null,Object? userName = null,Object? userAvatar = null,Object? createdAt = null,Object? updatedAt = null,Object? updatedBy = null,}) {
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$TripSnapshotResponseCopyWith<TripSnapshotResponse> get copyWith => _$TripSnapshotResponseCopyWithImpl<TripSnapshotResponse>(this as TripSnapshotResponse, _$identity);

  /// Serializes this TripSnapshotResponse to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TripSnapshotResponse&&(identical(other.name, name) || other.name == name)&&(identical(other.startDate, startDate) || other.startDate == startDate)&&(identical(other.endDate, endDate) || other.endDate == endDate)&&const DeepCollectionEquality().equals(other.itinerary, itinerary));
}
...
@override
String toString() {
  return 'TripSnapshotResponse(name: $name, startDate: $startDate, endDate: $endDate, itinerary: $itinerary)';
}
...
/// @nodoc
abstract mixin class $TripSnapshotResponseCopyWith<$Res>  {
...
/// @nodoc
class _$TripSnapshotResponseCopyWithImpl<$Res>
    implements $TripSnapshotResponseCopyWith<$Res> {
  _$TripSnapshotResponseCopyWithImpl(this._self, this._then);

  final TripSnapshotResponse _self;
  final $Res Function(TripSnapshotResponse) _then;
...
/// Adds pattern-matching-related methods to [TripSnapshotResponse].
extension TripSnapshotResponsePatterns on TripSnapshotResponse {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _TripSnapshotResponse value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _TripSnapshotResponse value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _TripSnapshotResponse value)?  $default,){
final _that = this;
switch (_that) {
case _TripSnapshotResponse() when $default != null:
return $default(_that);case _:
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$TripSnapshotResponseCopyWith<_TripSnapshotResponse> get copyWith => __$TripSnapshotResponseCopyWithImpl<_TripSnapshotResponse>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$TripSnapshotResponseToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TripSnapshotResponse&&(identical(other.name, name) || other.name == name)&&(identical(other.startDate, startDate) || other.startDate == startDate)&&(identical(other.endDate, endDate) || other.endDate == endDate)&&const DeepCollectionEquality().equals(other._itinerary, _itinerary));
}
...
/// @nodoc
abstract mixin class _$TripSnapshotResponseCopyWith<$Res> implements $TripSnapshotResponseCopyWith<$Res> {
...
/// @nodoc
class __$TripSnapshotResponseCopyWithImpl<$Res>
    implements _$TripSnapshotResponseCopyWith<$Res> {
  __$TripSnapshotResponseCopyWithImpl(this._self, this._then);

  final _TripSnapshotResponse _self;
  final $Res Function(_TripSnapshotResponse) _then;
...
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? startDate = null,Object? endDate = freezed,Object? itinerary = null,}) {
  return _then(_TripSnapshotResponse(
name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String,startDate: null == startDate ? _self.startDate : startDate // ignore: cast_nullable_to_non_nullable
as DateTime,endDate: freezed == endDate ? _self.endDate : endDate // ignore: cast_nullable_to_non_nullable
...
@JsonKey(name: 'start_date')@DateOnlyConverter() DateTime get startDate;@JsonKey(name: 'end_date')@NullableDateOnlyConverter() DateTime? get endDate;@JsonKey(name: 'max_members', defaultValue: 0) int get maxMembers;@JsonKey(name: 'approval_required', defaultValue: false) bool get approvalRequired;@JsonKey(name: 'private_message') String? get privateMessage;@JsonKey(name: 'linked_trip_id') String? get linkedTripId;
...
@useResult
$Res call({
 String title, String description,@JsonKey(defaultValue: GroupEventCategory.other) GroupEventCategory category, String location,@JsonKey(name: 'start_date')@DateOnlyConverter() DateTime startDate,@JsonKey(name: 'end_date')@NullableDateOnlyConverter() DateTime? endDate,@JsonKey(name: 'max_members', defaultValue: 0) int maxMembers,@JsonKey(name: 'approval_required', defaultValue: false) bool approvalRequired,@JsonKey(name: 'private_message') String? privateMessage,@JsonKey(name: 'linked_trip_id') String? linkedTripId
});
...
class _GroupEventCreateRequest implements GroupEventCreateRequest {
  const _GroupEventCreateRequest({required this.title, required this.description, @JsonKey(defaultValue: GroupEventCategory.other) required this.category, required this.location, @JsonKey(name: 'start_date')@DateOnlyConverter() required this.startDate, @JsonKey(name: 'end_date')@NullableDateOnlyConverter() this.endDate, @JsonKey(name: 'max_members', defaultValue: 0) required this.maxMembers, @JsonKey(name: 'approval_required', defaultValue: false) required this.approvalRequired, @JsonKey(name: 'private_message') this.privateMessage, @JsonKey(name: 'linked_trip_id') this.linkedTripId});
...
@override
String toString() {
  return 'GroupEventUpdateRequest(title: $title, description: $description, category: $category, location: $location, startDate: $startDate, endDate: $endDate, maxMembers: $maxMembers, approvalRequired: $approvalRequired, privateMessage: $privateMessage, linkedTripId: $linkedTripId)';
}
...
/// Create a copy of GroupEventUpdateRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? title = freezed,Object? description = freezed,Object? category = freezed,Object? location = freezed,Object? startDate = freezed,Object? endDate = freezed,Object? maxMembers = freezed,Object? approvalRequired = freezed,Object? privateMessage = freezed,Object? linkedTripId = freezed,}) {
  return _then(_self.copyWith(
...
mixin _$GroupEventReviewRequest {
 ...
 String get status; String? get note;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GroupEventReviewRequest&&(identical(other.status, status) || other.status == status)&&(identical(other.note, note) || other.note == note));
}
...
@override
String toString() {
  return 'GroupEventReviewRequest(status: $status, note: $note)';
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String status,  String? note)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GroupEventReviewRequest() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String status,  String? note)  $default,) {final _that = this;
switch (_that) {
case _GroupEventReviewRequest():
return $default(_that.status,_that.note);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String status,  String? note)?  $default,) {final _that = this;
switch (_that) {
case _GroupEventReviewRequest() when $default != null:
return $default(_that.status,_that.note);case _:
  return null;
...
class _GroupEventReviewRequest implements GroupEventReviewRequest {
  const _GroupEventReviewRequest({required this.status, this.note});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _GroupEventReviewRequest&&(identical(other.status, status) || other.status == status)&&(identical(other.note, note) || other.note == note));
}
...
/// @nodoc
mixin _$GroupEventTripLinkRequest {

@JsonKey(name: 'linked_trip_id') String? get linkedTripId;
/// Create a copy of GroupEventTripLinkRequest
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$GroupEventTripLinkRequestCopyWith<GroupEventTripLinkRequest> get copyWith => _$GroupEventTripLinkRequestCopyWithImpl<GroupEventTripLinkRequest>(this as GroupEventTripLinkRequest, _$identity);

  /// Serializes this GroupEventTripLinkRequest to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GroupEventTripLinkRequest&&(identical(other.linkedTripId, linkedTripId) || other.linkedTripId == linkedTripId));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,linkedTripId);

@override
String toString() {
  return 'GroupEventTripLinkRequest(linkedTripId: $linkedTripId)';
}
...
/// @nodoc
abstract mixin class $GroupEventTripLinkRequestCopyWith<$Res>  {
  factory $GroupEventTripLinkRequestCopyWith(GroupEventTripLinkRequest value, $Res Function(GroupEventTripLinkRequest) _then) = _$GroupEventTripLinkRequestCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$GroupEventTripLinkRequestCopyWithImpl<$Res>
    implements $GroupEventTripLinkRequestCopyWith<$Res> {
  _$GroupEventTripLinkRequestCopyWithImpl(this._self, this._then);

  final GroupEventTripLinkRequest _self;
  final $Res Function(GroupEventTripLinkRequest) _then;

/// Create a copy of GroupEventTripLinkRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? linkedTripId = freezed,}) {
  return _then(_self.copyWith(
linkedTripId: freezed == linkedTripId ? _self.linkedTripId : linkedTripId // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
/// Adds pattern-matching-related methods to [GroupEventTripLinkRequest].
extension GroupEventTripLinkRequestPatterns on GroupEventTripLinkRequest {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _GroupEventTripLinkRequest value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _GroupEventTripLinkRequest() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _GroupEventTripLinkRequest value)  $default,){
final _that = this;
switch (_that) {
case _GroupEventTripLinkRequest():
return $default(_that);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _GroupEventTripLinkRequest value)?  $default,){
final _that = this;
switch (_that) {
case _GroupEventTripLinkRequest() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'linked_trip_id')  String? linkedTripId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GroupEventTripLinkRequest() when $default != null:
return $default(_that.linkedTripId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'linked_trip_id')  String? linkedTripId)  $default,) {final _that = this;
switch (_that) {
case _GroupEventTripLinkRequest():
return $default(_that.linkedTripId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'linked_trip_id')  String? linkedTripId)?  $default,) {final _that = this;
switch (_that) {
case _GroupEventTripLinkRequest() when $default != null:
return $default(_that.linkedTripId);case _:
  return null;
...
class _GroupEventTripLinkRequest implements GroupEventTripLinkRequest {
  const _GroupEventTripLinkRequest({@JsonKey(name: 'linked_trip_id') this.linkedTripId});
  factory _GroupEventTripLinkRequest.fromJson(Map<String, dynamic> json) => _$GroupEventTripLinkRequestFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$GroupEventTripLinkRequestCopyWith<_GroupEventTripLinkRequest> get copyWith => __$GroupEventTripLinkRequestCopyWithImpl<_GroupEventTripLinkRequest>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$GroupEventTripLinkRequestToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _GroupEventTripLinkRequest&&(identical(other.linkedTripId, linkedTripId) || other.linkedTripId == linkedTripId));
}
...
/// @nodoc
abstract mixin class _$GroupEventTripLinkRequestCopyWith<$Res> implements $GroupEventTripLinkRequestCopyWith<$Res> {
  factory _$GroupEventTripLinkRequestCopyWith(_GroupEventTripLinkRequest value, $Res Function(_GroupEventTripLinkRequest) _then) = __$GroupEventTripLinkRequestCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: 'linked_trip_id') String? linkedTripId
});
...
/// @nodoc
class __$GroupEventTripLinkRequestCopyWithImpl<$Res>
    implements _$GroupEventTripLinkRequestCopyWith<$Res> {
  __$GroupEventTripLinkRequestCopyWithImpl(this._self, this._then);

  final _GroupEventTripLinkRequest _self;
  final $Res Function(_GroupEventTripLinkRequest) _then;

/// Create a copy of GroupEventTripLinkRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? linkedTripId = freezed,}) {
  return _then(_GroupEventTripLinkRequest(
linkedTripId: freezed == linkedTripId ? _self.linkedTripId : linkedTripId // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
