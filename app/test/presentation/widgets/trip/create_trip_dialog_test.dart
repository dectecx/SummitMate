...
void main() {
  ...
  group('CreateTripDialog Widget Test', () {
    ...
    testWidgets(
      'Given creating new trip, When calling CreateTripDialog Widget Test, Then it should display correct title',
    ...
    testWidgets(
      'Given editing trip, When calling CreateTripDialog Widget Test, Then it should display correct title and initial values',
      (WidgetTester tester) async {
        final trip = Trip(
          id: '1',
          userId: 'u1',
    ...
    testWidgets(
      'Given form is valid and submitted, When calling CreateTripDialog Widget Test, Then it should invoke addTrip on Cubit',
      (WidgetTester tester) async {
    ...
    testWidgets(
      'Given name is empty, When calling CreateTripDialog Widget Test, Then it should show validation error',
      (WidgetTester tester) async {
        await tester.pumpWidget(
          MaterialApp(
            home: BlocProvider<TripCubit>.value(value: mockTripCubit, child: const CreateTripDialog()),
