...
func (s *APITestSuite) TestHealthCheck_Success() {
	s.Run("Given default context, When calling HealthCheck Success, Then it should perform successfully", func() {
...
func (s *APITestSuite) TestRegister_Success() {
	s.Run("Given default context, When calling Register Success, Then it should perform successfully", func() {
		email := randomEmail()
...
func (s *APITestSuite) TestRegister_DuplicateEmail() {
	s.Run("Given default context, When calling Register DuplicateEmail, Then it should perform successfully", func() {
		email := randomEmail()
...
func (s *APITestSuite) TestRegister_PasswordTooShort() {
	s.Run("Given default context, When calling Register PasswordTooShort, Then it should perform successfully", func() {
		payload := api.RegisterRequest{
...
func (s *APITestSuite) TestLogin_Success() {
	s.Run("Given default context, When calling Login Success, Then it should perform successfully", func() {
		email := randomEmail()
...
func (s *APITestSuite) TestLogin_InvalidPassword() {
	s.Run("Given default context, When calling Login InvalidPassword, Then it should perform successfully", func() {
		email := randomEmail()
...
func (s *APITestSuite) TestLogin_AccountNotFound() {
	s.Run("Given default context, When calling Login AccountNotFound, Then it should perform successfully", func() {
...
func (s *APITestSuite) TestGetMe_Success() {
	s.Run("Given default context, When calling GetMe Success, Then it should perform successfully", func() {
		email := randomEmail()
...
func (s *APITestSuite) TestGetMe_NoToken() {
	s.Run("Given default context, When calling GetMe NoToken, Then it should perform successfully", func() {
...
func (s *APITestSuite) TestRefreshToken_Success() {
	s.Run("Given default context, When calling RefreshToken Success, Then it should perform successfully", func() {
		email := randomEmail()
