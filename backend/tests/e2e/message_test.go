...
func (s *APITestSuite) TestMessage_CRUD() {
	s.Run("Given default context, When calling Message CRUD, Then it should perform successfully", func() {
...
func (s *APITestSuite) TestMessage_Reply() {
	s.Run("Given default context, When calling Message Reply, Then it should perform successfully", func() {
