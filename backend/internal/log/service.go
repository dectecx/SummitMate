...
type LogService interface {
	UploadLogs(ctx context.Context, deviceID, deviceName string, logs []LogEntry) (int, error)
}
...
func NewLogService(logger *slog.Logger, repo LogRepository) LogService {
	return &logService{
...
func (s *logService) UploadLogs(ctx context.Context, deviceID, deviceName string, logs []LogEntry) (int, error) {
