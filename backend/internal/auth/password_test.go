...
func TestHashPassword_Success(t *testing.T) {
	t.Run("Given a plain text password, When hashing it, Then it should return a valid bcrypt hash", func(t *testing.T) {
...
func TestCheckPasswordHash_Valid(t *testing.T) {
	t.Run("Given a correct password and its hash, When verifying, Then it should return true", func(t *testing.T) {
...
func TestCheckPasswordHash_Invalid(t *testing.T) {
	t.Run("Given an incorrect password, When verifying against the hash, Then it should return false", func(t *testing.T) {
...
func TestHashPassword_DifferentHashes(t *testing.T) {
	t.Run("Given the same password hashed twice, When comparing the hashes, Then they should be different due to salt", func(t *testing.T) {
