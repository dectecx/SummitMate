...
func TestGenerateAndParseToken_Success(t *testing.T) {
	t.Run("Given a valid user, When generating and parsing a token, Then it should succeed without error", func(t *testing.T) {
...
func TestParseToken_InvalidToken(t *testing.T) {
	t.Run("Given an invalid token string, When parsing it, Then it should return an invalid token error", func(t *testing.T) {
		manager := tokens.NewTokenManager(testSecret)
...
func TestParseToken_ExpiredToken(t *testing.T) {
	t.Run("Given an expired token, When parsing it, Then it should return an expired error", func(t *testing.T) {
		manager := tokens.NewTokenManager(testSecret)
...
func TestParseToken_InvalidSecret(t *testing.T) {
	t.Run("Given a token signed with a different secret, When parsing it, Then it should return an invalid signature error", func(t *testing.T) {
