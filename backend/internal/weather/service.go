...
// ListAll 取得所有天氣資料
func (s *weatherService) ListAll(ctx context.Context) ([]WeatherRecord, error) {
	return s.repo.ListAll(ctx)
}

// ListByLocation 取得特定地點的天氣資料
func (s *weatherService) ListByLocation(ctx context.Context, location string) ([]WeatherRecord, error) {
...
func (s *weatherService) aggregate(rows []rawRow, issueTime *time.Time) []WeatherRecord {
