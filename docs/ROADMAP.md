...
## Phase 21: 離線地圖與定位 (Offline Map & GPS) ✅

### 目標
整合 GPX 軌跡顯示、離線圖資下載與即時使用者定位，確保無網路環境下仍能安全導航。

### 任務
- [x] **OpenStreetMap 整合**: `flutter_map` 基礎建設
- [x] **GPX 處理**: 軌跡與 Waypoint 解析與繪製
- [x] **離線圖資**: `flutter_map_tile_caching` v10 整合，支援自訂區域下載
- [x] **使用者定位**: 顯示目前位置 (Blue Dot) 與電子羅盤指向 (Heading)
- [x] **UX 優化**: 平滑移動動畫 (Animated Map Move)
